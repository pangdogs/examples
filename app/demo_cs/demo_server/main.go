...
func main() {
	framework.NewApp().
		Setup(misc.Gate, framework.NewServiceGenericT[serv.GateService]()).
		Setup(misc.Work, framework.NewServiceGenericT[serv.WorkService]()).
		InitCB(generic.MakeDelegateAction1(func(*cobra.Command) {
